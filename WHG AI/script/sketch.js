...
var winArea;//determina la win area
...
function setup() {
  ...
  //non fa spostare la finestra del browser
...
function draw(){
 ...
 if (humanPlaying) {//controlla chi sta usando il main square
   if ((p.dead && p.fadeCounter<=0) || p.reachedGoal) {
     ...
     //update dei dots e player, output onscreen
 ...
 } else//cose per riprodurre le bst gen e i best player
